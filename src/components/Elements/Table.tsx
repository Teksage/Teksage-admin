...
// //     () =>
// //       data.some(
// //         (item) => item["booking_date" as keyof T] || item["date" as keyof T] || item["sent_by_date" as keyof T]
// //       ),
// //     [data]
// //   );
...
//     return (
//       <>
//         <StyledFormControl size="small" sx={{ minWidth: { xs: "100%", sm: 200 }, maxWidth: { xs: "100%", sm: 450 } }}>
//           <InputLabel>Fee Range</InputLabel>
//           <Select
