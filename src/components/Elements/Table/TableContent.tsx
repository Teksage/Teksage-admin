...
//   return (
//     <StyledPaper sx={{ position: "relative", height: tableHeight }}>
//       {loading && (
//         <Box
//           sx={{
//             position: "absolute",
...
//                 <Skeleton variant="text" width="20px" height={30} />
//                 {columns
//                   .filter((col) => !col.filterOnly) // Skip filterOnly columns during loading
//                   .map((_, colIndex) => (
//                     <Skeleton
//                       key={colIndex}
//                       variant="text"
...
//                 </TableCell>
//                 {columns
//                   .filter((col) => !col.filterOnly) // Skip filterOnly columns
//                   .map((column) => (
//                     <TableCell
//                       key={column.id as string}
//                       sortDirection={
...
//                         width: `${
//                           100 /
//                           (columns.filter((col) => !col.filterOnly).length +
//                             (showActions ? 1 : 0))
//                         }%`,
//                         minWidth: "120px",
//                         maxWidth: "220px",
...
//                                 width: `${
//                                   100 /
//                                   (columns.filter((col) => !col.filterOnly)
//                                     .length +
//                                     (showActions ? 1 : 0))
//                                 }%`,
//                                 minWidth: "120px",
...
const TableContent = <T,>({
  ...
  const visibleColumns = useMemo(() => {
    if (isMobile) {
      return dataColumns.slice(0, Math.min(dataColumns.length, 2));
    }
    return dataColumns;
  }, [dataColumns, isMobile]);
          ...
          <Table stickyHeader aria-label="data table">
            ...
            <TableBody>
              {paginatedData.length === 0 ? (
                <TableRow>
                  <TableCell
                    colSpan={dataColumns.length + (showActions ? 2 : 1)}
                    sx={{
                      textAlign: "center",
                      py: 4,
                      fontFamily: "Urbanist",
