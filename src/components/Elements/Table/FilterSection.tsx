...
const FilterSection = <T,>({
  ...
  const handleClearDate = () => {
    setSelectedPreset(""); // Reset preset to default
    setTempDateRange({ start: null, end: null }); // Clear date range
    setAnchorEl(null); // Close the popover if open
    handleDateRangeChange(null, null); // Notify parent component of cleared dates
  };
  ...
  const renderDateFilter = () => {
    ...
    return (
      ...
      >
        ...
        {/* Conditionally render Clear Date Button */}
        {selectedPreset && (
          <Button
            variant="outlined"
            ...
            sx={{
              fontFamily: "Urbanist",
              fontWeight: 600,
              color: "#d32f2f", // Red color for "clear" action
              borderColor: "#d32f2f",
              borderRadius: "8px",
              textTransform: "none",
              px: { xs: 2, sm: 3 },
              ...
              whiteSpace: "nowrap",
              width: { xs: "100%", sm: "100%" }, // Match the width of the Select dropdown
              maxWidth: { xs: "100%", sm: 200 }, // Same maxWidth as the Select dropdown
            }}
          >
            Clear Date
          </Button>
