...
// // import { validateEmail } from "../Elements/CommonValidations";
...
//   const debouncedVerifyOtp = useMemo(
//     () =>
//       debounce(() => {
//         handleVerifyOtp();
//       }, 500),
...
//     };
//   }, [state.otp, state.step, debouncedVerifyOtp]);
...
//         dispatchState({
//           type: "SET_ERROR",
//           error: "This is taking longer than expected. Please wait...",
//         });
//       }, 5000);
...
//                   <svg
//                     className="animate-spin h-6 w-6 text-[#10b100]"
...
//                       variant="body2"
//                       color="text.secondary"
//                       style={{ fontFamily: "Urbanist", fontStyle: "italic" }}
//                     >
//                       {state.error}
//                     </Typography>
//                   )}
...
import React, { useEffect, useRef, useCallback, useReducer, useMemo } from "react";
import { Box, Paper, alpha, Typography, Skeleton, Button } from "@mui/material";
import { styled } from "@mui/material/styles";
import { useNavigate } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import astro_prompt_logo_login from "../../assets/astro_prompt_logo_login.png";
