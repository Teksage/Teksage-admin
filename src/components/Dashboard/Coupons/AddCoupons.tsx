  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDateFns}>
      ...
      >
        ...
        >
          <IconButton
            onClick={() => navigate("/dashboard/coupons", { replace: true })}
            sx={{
              mr: 1,
              color: "#06402B",
              "&:hover": {
                  ...
                  <Grid item xs={12} sm={6}>
                    <DatePicker
                      ...
                      onChange={(newValue) => {
                        ...
                        if (newValue) {
                          // Ensure end_date is not before start_date or today
                          const minDate = formData.start_date
                            ? new Date(formData.start_date.getTime())
                            : today;
                          minDate.setHours(0, 0, 0, 0); // Set to midnight for accurate date comparison
