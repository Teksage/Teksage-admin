...
export const ASK_DETAIL_PAGE = {
  ...
  sectionEventPlan: "Event Plan (Muhurtha)",
  labelEventPlanDate: "Date",
  labelEventPlanStatus: "Status",
  labelEventPlanDetails: "Details",
  labelEventPlanSuitable: "Suitable",
  labelEventPlanNotSuitable: "Not suitable",
  labelEventPlanMorning: "Morning",
  labelEventPlanEvening: "Evening",
  labelEventPlanFullDay: "Full day",
